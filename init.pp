...
$my_deps= ['curl', 'debugedit', 'dialog', 'fontconfig',
  ...
  file{ '/tmp/check-mk-raw-1.2.8p11_0.trusty_amd64.deb':
    ensure => present,
    mode   => '640',
   #source =>  "puppet:///modules/check_mk/check-mk-raw-1.2.8p11_0.trusty_amd64.deb",
    }


  package { 'check-mk-raw-1.2.8p11_0.trusty_amd64.deb':
    provider => 'dpkg',
    ensure   => present,
